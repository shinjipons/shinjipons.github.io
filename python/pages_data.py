...
pages = {
    "apple-letter": {
        ...
        "paragraph_3": "The biggest challenge in this exercise to avoid flat planes in the transition areas where the main pipes of the bubble letter meet. If I were to only aim for G2 continuity and didn't care too much for heavy surfaces, it could work. But what would be the fun in that?",
        "paragraph_4" : "While this result looks OK, there is lots I can improve on. The transition areas are too flat and I went for too much of a pill-shaped profile. If you are willing to teach me the proper techniques, please get in touch."
    }
}