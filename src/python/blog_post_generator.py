...
def generate_html_from_markdown(markdown_filepath):
    ...
    with open(markdown_filepath, 'r') as file:
        ...
        for line in lines:
            if len(line) == 0 or line.startswith(("---", "date:", "description: ", "title:", "author:")): # Empty lines and front matter
                pass
    ...
    <body>
        <main>
            <div class="left-column">
                ...
                <ul id="article-outline" class="monospace padding-between-items">{post_title}
                </ul>
            </div>
